 ...
 * @author Google
 */
public class TextNumberPicker extends LinearLayout implements OnClickListener,
    ...
    public interface OnChangedListener {
        void onChanged(TextNumberPicker picker, int oldVal, int newVal);
    }
     ...
     */
    public static final TextNumberPicker.Formatter TWO_DIGIT_FORMATTER =
            new TextNumberPicker.Formatter() {
    ...
    protected final EditText mText;
    ...
    public TextNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        setOrientation(VERTICAL);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.text_number_picker, this, true);
        mHandler = new Handler();
        InputFilter inputFilter = new NumberPickerInputFilter();
        mNumberInputFilter = new NumberRangeKeyListener();
        mIncrementButton = (TextNumberPickerButton) findViewById(R.id.increment);
        mIncrementButton.setOnClickListener(this);
        mIncrementButton.setOnLongClickListener(this);
        mIncrementButton.setNumberPicker(this);
        mDecrementButton = (TextNumberPickerButton) findViewById(R.id.decrement);
    ...
    protected void updateView() {
        ...
        if (mDisplayedValues == null) {
            ...
            mText.setText(mDisplayedValues[mCurrent - getStart()]);
        }
    ...
    private TextNumberPickerButton mIncrementButton;
    private TextNumberPickerButton mDecrementButton;
    ...
    private class NumberRangeKeyListener extends NumberKeyListener {
        ...
        // NOTE This doesn't allow for range limits when controlled by a
        // soft input method!
